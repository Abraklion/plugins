(self["webpackChunkgulp_html_scss"] = self["webpackChunkgulp_html_scss"] || []).push([["progress"],{

/***/ "./src/js/library/progressJs/progress.js":
/*!***********************************************!*\
  !*** ./src/js/library/progressJs/progress.js ***!
  \***********************************************/
...
/* harmony import */ var _library_progressJs_progress__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./library/progressJs/progress */ "./src/js/library/progressJs/progress.js");
/* harmony import */ var _library_progressJs_progress__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_library_progressJs_progress__WEBPACK_IMPORTED_MODULE_0__);
...
/** для всего документа */
let progressDocument = (0,_library_progressJs_progress__WEBPACK_IMPORTED_MODULE_0__.progressJs)().setOptions({
  'theme': 'blue',
  'overlayMode': false
}).start();
setInterval(() => {
...
// блок с текстом
let progressText = (0,_library_progressJs_progress__WEBPACK_IMPORTED_MODULE_0__.progressJs)('.loading--text').setOptions({
  'theme': 'black',
  'overlayMode': false
}).start();
setInterval(() => {
...
// три картинки
let progressImg = (0,_library_progressJs_progress__WEBPACK_IMPORTED_MODULE_0__.progressJs)('.loading--img').setOptions({
...
// одна большая
let progressImgBig = (0,_library_progressJs_progress__WEBPACK_IMPORTED_MODULE_0__.progressJs)('.loading--img-big').setOptions({
  'theme': 'blackOverlayRadiusWithPercentBar',
  'overlayMode': true
}).start();
setInterval(() => {
...
/******/ var __webpack_exports__ = (__webpack_exec__("./src/js/progressJs.js"));
/******/ }
]);
